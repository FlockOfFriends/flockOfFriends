    ...
    return (
        <div className="aboutCreators">
            ...
            <div className="aboutCreatorsHeading">
                <h2 className="aboutHeader">About Creators</h2>
            </div>
                            ...
                            <div className="creatorContainer">
                                <div className="mockupContainer">
                                    <a target="_blank" href="https://www.briancharlesoreilly.com/"> 
                                        ...
                                        <span className="sr-only">Link to Brian's Portfolio</span>
                                    </a>
                                </div>
                                ...
                                <div className="creatorInfo">
                                    ...
                                    <div className="socialIcons">                                    {/* <FontAwesomeIcon icon="fas fa-browser" /> */}
                                        <a href="https://www.linkedin.com/in/brian-charles-oreilly/">
                                            ...
                                            <span className="sr-only">Link to Brian's Linkedin profile</span>
                                        </a>

                                        <a href="https://github.com/briancharlesoreilly">
                                            <img src={iconGithub} alt="Github icon" />
                                            <span className="sr-only">Link to Brian's Github profile</span>
                                        </a>
                                    </div>
                            ...
                            <div className="creatorContainer">
                                <div className="mockupContainer">
                                    <a href="https://www.beaferreira.ca/">
                                        ...
                                        <span className="sr-only">Link to Bea's Portfolio</span>
                                    </a>
                                </div>
                                ...
                                <div className="creatorInfo">
                                    ...
                                    <div className="socialIcons">
                                        <a href="https://www.linkedin.com/in/beatrizfb/" >
                                            <img src={iconLink} alt="Linkedin icon" />
                                            <span className="sr-only">Link to Bea's Linkedin profile</span>
                                        </a>
                                        <a href="https://github.com/becarolf" >
                                            <img src={iconGithub} alt="Github icon" />
                                            <span className="sr-only">Link to Bea's Github profile</span>
                                        </a>
                                    </div>
                        ...
                        <li className="marlies">
                            <div className="creatorContainer">
                                <div className="mockupContainer">
                                    ...
                                    <span className="sr-only">Link to Marlies Portfolio</span>
                                    </a>
                                </div>
                                ...
                                <div className="creatorInfo">
                                    ...
                                    <div className="socialIcons">
                                        <a href="https://www.linkedin.com/in/marlies-zimmer/" >
                                            <img src={iconLink} alt="Linkedin icon" />
                                            <span className="sr-only">Link to Marlies' Linkedin profile</span>
                                        </a>
                                        <a href="https://github.com/mzmarlies" >
                                            <img src={iconGithub} alt="Github icon" />
                                            <span className="sr-only">Link to Marlies Github profile</span>
                                        </a>
                                    </div>
                            ...
                            <div className="creatorContainer">
                                <div className="mockupContainer">
                                    <a href="https://www.skorzenstein.com/" >
                                        ...
                                        <span className="sr-only">Link to Stephen's Portfolio</span>
                                    </a>
                                </div>
                                ...
                                <div className="creatorInfo">
                                    ...
                                    <div className="socialIcons">
                                        <a href="https://www.linkedin.com/in/skorzenstein/" aria-label="Linkedin Link">
                                            <img src={iconLink} alt="Linkedin icon" />
                                            <span className="sr-only">Link to Stephen's Linkedin profile</span>
                                        </a>
                                        <a href="https://github.com/korzenstein" aria-label="Github Link">
                                            <img src={iconGithub} alt="Github icon" />
                                            <span className="sr-only">Link to Stephen's Github profile</span>
                                        </a>
                                    </div>
